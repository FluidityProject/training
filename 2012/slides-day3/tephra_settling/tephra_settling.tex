...
\frame{
  ...
  \begin{itemize}
    ...
    \item No normal flow boundary conditions are weakly imposed along with a zero velocity initial condition.\newline
...
\begin{figure}[H]
        \centering
                \includegraphics[scale=0.25]{./tephra_settling/tephra_fine_1.png}\hspace{0.1cm}
                \includegraphics[scale=0.25]{./tephra_settling/tephra_fine_2.png}\hspace{0.1cm}
                \includegraphics[scale=0.25]{./tephra_settling/tephra_fine_3.png}\hspace{0.1cm}
                \includegraphics[scale=0.25]{./tephra_settling/tephra_fine_4.png}\hspace{0.1cm}
                \includegraphics[scale=0.25]{./tephra_settling/tephra_fine_5.png}
...
\frame{
 ...
 \begin{itemize}
    ...
    \item Alter the particle diameter to observe its effect on plume formation.\newline
    \item Add a second particle phase (with a different particle diameter).
 \end{itemize}
}
