...
\begin{tikzpicture}
  \begin{semilogxaxis}[
    ...
    \addplot[color=red, solid, thick] plot coordinates { (0.01,44.3468288202) (1,44.3468288202)};
    \addlegendentry{analytic};
    \addplot[color=blue, solid, line join=round, error bars/.cd, y dir=both, y explicit] table[x=elmin, y=angle_mean, y error=angle_std] {table-fixed/st-andrews-cross-validation_data.pgfdat};
    \addlegendentry{fixed mesh};
    \addplot[color=green!60!black, solid, line join=round, error bars/.cd, y dir=both, y explicit] table[x=elmin, y=angle_mean, y error=angle_std] {table-adaptive/st-andrews-cross-validation_data.pgfdat};
